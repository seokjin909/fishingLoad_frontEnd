...
import { FaRegCalendarAlt, FaRegCommentDots,FaMapMarkerAlt } from 'react-icons/fa';
...
export const ContentSection = ({store,userId}:Props) => {
  ...
  return (
    <>
      <div className='flex justify-center items-center w-full h-16 border-t-2 border-b-2 font-bold'>전국 포인트 - 바다 🌊</div>
        ...
        <div className='border p-4'>
          ...
          <div className='flex justify-center gap-10 w-full text-center items-center h-3/5'>
            <div className='flex flex-col items-center'>
              <div className='w-28 h-28 rounded-full bg-blue-300'>{store.fishtype}</div>
            </div>
            <div className='flex flex-col items-center'>
              <div className='w-28 h-28 rounded-full bg-blue-300'>{store.category.name}</div>
            </div>
            <div className='flex flex-col items-center'>
